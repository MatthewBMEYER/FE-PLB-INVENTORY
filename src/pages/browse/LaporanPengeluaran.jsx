...
export default function BrowseLaporan() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await api.browse.laporan_pengeluaran.search(params);
  ...
  const handleExport = async () => {
    try {
      const params = new URLSearchParams(filters).toString();
      const response = await api.browse.laporan_pengeluaran.download(params);
      ...
      a.href = url;
      a.download = "Laporan_Pengeluaran.xlsx";
      a.click();
            ...
            <tbody>
              {currentData.map((d) => (
                <tr key={d.no}>
                  ...
                  <td style={{ padding: "6px 10px" }}>{d.no_bukti_pengeluaran}</td>
                  <td style={{ padding: "6px 10px" }}>{d.tgl_bukti_pengeluaran}</td>
                  <td style={{ padding: "6px 10px" }}>{d.pembeli}</td>
                  ...
                  <td style={{ padding: "6px 10px", textAlign: "right" }}>{formatRupiah(d.nilai)}</td>
                </tr>
              ))}
            </tbody>
          </table>
